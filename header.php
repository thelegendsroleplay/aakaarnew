          ...
          <div class="relative flex items-center justify-between px-6 py-3">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="flex items-center space-x-2 group">
              <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg shadow-blue-500/30">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles h-5 w-5 text-white" role="img" aria-label="Aakaari logo"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"></path><path d="M20 3v4"></path><path d="M22 5h-4"></path><path d="M4 17v2"></path><path d="M5 18H3"></path></svg>
              </div>
              <span class="text-xl font-bold text-gray-900">Aakaari</span>
            </a>

            <nav class="hidden lg:flex items-center space-x-1">
              <a href="<?php echo esc_url(home_url('/')); ?>" class="px-5 py-3 rounded-full text-sm font-medium transition-all duration-200 <?php echo $current_page === 'home' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600 hover:bg-gray-50'; ?>">Home</a>
              <a href="<?php echo esc_url(home_url('/fix-an-issue/')); ?>" class="px-5 py-3 rounded-full text-sm font-medium transition-all duration-200 <?php echo $current_page === 'fix-an-issue' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600 hover:bg-gray-50'; ?>">Fix Issue</a>
              <a href="<?php echo esc_url(home_url('/maintenance/')); ?>" class="px-5 py-3 rounded-full text-sm font-medium transition-all duration-200 <?php echo $current_page === 'maintenance' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600 hover:bg-gray-50'; ?>">Maintenance</a>
              <a href="<?php echo esc_url(home_url('/build-solutions/')); ?>" class="px-5 py-3 rounded-full text-sm font-medium transition-all duration-200 <?php echo $current_page === 'build-solutions' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600 hover:bg-gray-50'; ?>">Build</a>
              <a href="<?php echo esc_url(home_url('/blog/')); ?>" class="px-5 py-3 rounded-full text-sm font-medium transition-all duration-200 <?php echo $current_page === 'blog' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600 hover:bg-gray-50'; ?>">Blog</a>
            </nav>

            <div class="hidden lg:flex items-center space-x-3">
              <a href="<?php echo esc_url(home_url('/login/')); ?>" class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:bg-accent dark:hover:bg-accent/50 h-12 px-4 py-2 has-[>svg]:px-3 rounded-full text-gray-600 hover:text-blue-600">Dashboard</a>
              <a href="<?php echo esc_url(home_url('/fix-an-issue/')); ?>" class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:bg-primary/90 h-12 px-4 py-2 has-[>svg]:px-3 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg shadow-blue-500/30">Get Started</a>
            </div>

            <button data-mobile-menu-toggle class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50 h-12 w-12 lg:hidden rounded-full text-gray-600" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="aakaari-mobile-menu" aria-label="Open menu">
