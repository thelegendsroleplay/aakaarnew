...
<div class="client-portal-page">
  <aside class="sidebar">
    ...
    <div class="nav-scroll">
      ...
      <button class="nav-item active" type="button" onclick="clientPortal.nav('home', this)">
        <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
        Dashboard
      </button>
      <button class="nav-item" type="button" onclick="clientPortal.nav('support', this)">
        <svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
        Support Tickets
      </button>
      <button class="nav-item" type="button" onclick="clientPortal.nav('projects', this)">
        <svg viewBox="0 0 24 24"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
        Projects
      </button>

      <div class="nav-header">Management</div>
      <button class="nav-item" type="button" onclick="clientPortal.nav('websites', this)">
        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
        Websites
      </button>
      <button class="nav-item" type="button" onclick="clientPortal.nav('files', this)">
      ...
      <button class="nav-item" type="button" onclick="clientPortal.nav('billing', this)">
          ...
          <div class="ticket-grid">
            <div class="card" style="margin:0; overflow:hidden; display:flex; flex-direction:column;">
              ...
              <div class="ticket-list">
                <button class="ticket-item selected" type="button" onclick="clientPortal.loadTicket(1)">
                ...
                <button class="ticket-item" type="button" onclick="clientPortal.loadTicket(2)">
                  <div class="ticket-meta">
  ...
  <div class="modal" id="ticketModal">
    <div class="modal-box">
      ...
      <select id="ticket-type" class="form-input" style="margin-bottom:16px;">
      ...
      <input id="ticket-subject" type="text" class="form-input" placeholder="e.g. Broken Contact Form">
      ...
      <textarea id="ticket-description" class="form-input" rows="4" style="font-family:inherit;"></textarea>
